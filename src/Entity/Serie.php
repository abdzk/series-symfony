...
class Serie
{
    ...
    #[ORM\Column(type: Types::DATE_MUTABLE)]
    private ?\DateTimeInterface $lastAireDate = null;
    ...
    public function getLastAireDate(): ?\DateTimeInterface
    {
        return $this->lastAireDate;
    }

    public function setLastAireDate(\DateTimeInterface $lastAireDate): self
    {
